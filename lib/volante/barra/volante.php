...
function ListaBancos($CodIAC,$CodBanco){
	$bd=Db::getInstance();
 $sql=" Select BCORESUMEN from bancos, cuentas  
	where 
	bcoCodigo = ctaBanco 
...
$observacion1  = 'hola esto es una observacion1';
$observacion2  = 'hola esto es una observacion2';
$observacion21  = 'hola esto es una observacion21';
...
if($cod_valor1>0 && $cod_fecha1<>''){
	...
	$pdf->Image("http://academico.unisimoncucuta.edu.co/volante/barcode.php?code=UCCEAN128&escapesequences=true&text=".$barcode1."&imageformat=4&dpi=72&rotation=0&modulewidth=0.5&unit=mm",$x,20+$y,283,38,"jpg");
} 
