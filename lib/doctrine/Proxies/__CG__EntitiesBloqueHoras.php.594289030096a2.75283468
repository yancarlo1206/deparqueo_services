 ...
 */
class BloqueHoras extends \Entities\BloqueHoras implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'codigo', 'horaIni', 'horaFin');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BloqueHoras $proxy) {
