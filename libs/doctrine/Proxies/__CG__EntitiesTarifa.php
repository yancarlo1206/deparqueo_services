 ...
 */
class Tarifa extends \Entities\Tarifa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'descripcion', 'fechainicio', 'fechafin', 'valor', 'tipotarifa', 'tipovehiculo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tarifa $proxy) {
    ...
    public function setTipotarifa($tipotarifa = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipotarifa', array($tipotarifa));

        return parent::setTipotarifa($tipotarifa);
    }
    ...
    public function getTipotarifa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipotarifa', array());

        return parent::getTipotarifa();
    }
