 ...
 */
class Tipovehiculo extends \Entities\Tipovehiculo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'descripcion', 'resumen');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tipovehiculo $proxy) {
