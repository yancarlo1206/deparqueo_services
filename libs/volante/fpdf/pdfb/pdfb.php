...
*/
  ...
  define('FPDF_FONTPATH',ROOT.'libs'.DS.'pdfb'.DS.'fpdf_fpdi'.DS.'font'.DS);
  require('fpdf_fpdi'.DS.'fpdi.php');
  require('barcode'.DS.'barcodeimage.php');
  ...
  class PDFB extends FPDI
  {
    ...
    {
      $barcode = substr(trim($barcode), 0, 60);
