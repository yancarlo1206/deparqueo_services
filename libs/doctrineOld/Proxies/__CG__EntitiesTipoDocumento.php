 ...
 */
class TipoDocumento extends \Entities\TipoDocumento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'descripcion', 'abreviatura', 'persona');
        }
